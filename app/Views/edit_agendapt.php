<div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal form-label-left" novalidate  action="<?= base_url('home/aksi_edit_agendapt')?>" method="post">
        ...
        <div class="item form-group">
          <label class="control-label col-12" >Persetujuan Dari Pihak Perusahaan <span class="required"></span>
          </label>
          <div class="col-12">
            <select id="persetujuan_pt" class="form-control col-12" data-validate-length-range="6" data-validate-words="2" name="persetujuan_pt" required="required">
              <option value="<?= $ferdi->persetujuan_pt?>"><?= $ferdi->persetujuan_pt; ?></option>
        ...
        <div class="form-group">
          <div class="col-md-6 col-md-offset-3">
            <a href="/home/agendapt" type="submit" class="btn btn-primary">Cancel</a></button>
