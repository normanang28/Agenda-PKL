<div class="card card-info">
        ...
        <div class="item form-group">
          ...
          <div class="col-12">
            <input type="text" id="email" name="email" placeholder="E-Mail" required="required" class="form-control col-12">
          </div>
        </div>
        ...
        <div class="item form-group">
          ...
          <div class="col-12">
            <input type="text" id="telp" name="telp" placeholder="No Telpon" required="required" class="form-control col-12">
          </div>
        </div>
        <div class="item form-group">
          ...
          <div class="col-12">
            <input type="text" id="username" name="username" placeholder="Username" required="required" class="form-control col-12">
          </div>
        </div>
        <div class="item form-group">
