<div class="card card-info">
        ...
        <div class="item form-group">
          ...
          <div class="col-12">
            <input type="text" id="jam_pulang" class="form-control col-12 "name="jam_pulang" required="required" placeholder="Jam Pulang" value="<?= $ferdi->jam_pulang?>">
          </div>
        </div>
        <div class="item form-group">
          ...
          <div class="col-12">
            <input type="text" id="rencana_pekerjaan" name="rencana_pekerjaan" placeholder="Rencana Pekerjaan" required="required" class="form-control col-12 " value="<?= $ferdi->rencana_pekerjaan?>">
          </div>
        </div>
        <div class="item form-group">
          ...
          <div class="col-12">
            <input type="text" id="relalisasi_pekerjaan" name="relalisasi_pekerjaan" placeholder="Realisasi Pekerjaan" required="required" class="form-control col-12 " value="<?= $ferdi->relalisasi_pekerjaan?>">
          </div>
        </div>
        <div class="item form-group">
          ...
          <div class="col-12">
            <input type="text" id="penugasan_atasan" name="penugasan_atasan" placeholder="Penugasan Atasan Dari Atasan" required="required" class="form-control col-12 " value="<?= $ferdi->penugasan_atasan?>">
          </div>
        </div>
        <div class="item form-group">
          ...
          <div class="col-12">
            <input type="text" id="penemuan_masalah" name="penemuan_masalah" placeholder="Penemuan Masalah" required="required" class="form-control col-12 " value="<?= $ferdi->penemuan_masalah?>">
          </div>
        </div>
